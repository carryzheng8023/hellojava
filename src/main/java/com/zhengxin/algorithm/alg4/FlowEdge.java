...
public class FlowEdge {
     ...
     * @throws IllegalArgumentException if <tt>capacity</tt> is negative
     */
     ...
     *    is a negative integer
     * @throws IllegalArgumentException if <tt>capacity</tt> is negative
     * @throws IllegalArgumentException unless <tt>flow</tt> is between
     ...
     *   (unless the edge represents a self-loop in which case it returns the same vertex)
     * @throws IllegalArgumentException if <tt>vertex</tt> is not one of the endpoints
     *   of the edge
     */
     ...
     * @throws IllegalArgumentException if <tt>vertex</tt> is not one of the endpoints
     *   of the edge
     * @throws IllegalArgumentException if <tt>delta</tt> makes the flow on
     *   on the edge either negative or larger than its capacity
     * @throws IllegalArgumentException if <tt>delta</tt> is <tt>NaN</tt>
     */
