package com.zhengxin.j2se.io;//: io/RecoverCADState.java
...
public class RecoverCADState {
    ...
    public static void main(String[] args) throws Exception {
        ObjectInputStream in = new ObjectInputStream(new FileInputStream("E:\\IntelliJ\\helloworld\\src\\main\\java\\com\\zhengxin\\j2se\\io\\CADState.out"));
