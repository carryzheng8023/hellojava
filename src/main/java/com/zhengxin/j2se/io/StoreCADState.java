package com.zhengxin.j2se.io;//: io/StoreCADState.java
...
public class StoreCADState {
    public static void main(String[] args) throws Exception {
        ...
        ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("E:\\IntelliJ\\helloworld\\src\\main\\java\\com\\zhengxin\\j2se\\io\\CADState.out"));
