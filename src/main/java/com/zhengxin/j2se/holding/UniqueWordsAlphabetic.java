package com.zhengxin.j2se.holding;//: holding/UniqueWordsAlphabetic.java
...
public class UniqueWordsAlphabetic {
  public static void main(String[] args) {
    ...
    words.addAll(new TextFile("E:\\IntelliJ\\helloworld\\src\\main\\java\\com\\zhengxin\\j2se\\holding\\SetOperations.java", "\\W+"));
