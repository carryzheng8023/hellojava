package com.zhengxin.j2se.generics;//: generics/WatercolorSets.java

import com.zhengxin.j2se.generics.watercolors.*;

import java.util.EnumSet;
import java.util.Set;

import static com.zhengxin.j2se.generics.watercolors.Watercolors.*;
import static com.zhengxin.j2se.net.mindview.util.Print.print;
import static com.zhengxin.j2se.net.mindview.util.Sets.*;
